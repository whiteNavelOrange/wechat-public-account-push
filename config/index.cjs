...
//       useTemplateId: 'jx4UqnqfXLOdjMMq_4LJOPvNyRtvBVjznYFi_EdajqE',
//       // 新历生日, 仅用作获取星座运势, 格式必须为MM-DD
//       horoscopeDate: '10-26',
//       festivals: [
//         // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
//         {
//           type: '*生日', name: '晗宝', year: '2001', date: '09-10',
//         },
...
//         // },
//         // {
//         //   type: '节日', name: '恋爱纪念日', year: '2023', date: '02-26',
//         // },
//       ],
//       // 我们在一起已经有xxxx天了的配置
//       customizedDateList: [
...
//   CALLBACK_TEMPLATE_ID: 'Mv4AGg1SiVyQyMMwIKzTtwwLAs1jk-ifzYpzYl36icE',
...
const USER_CONFIG = {
  ...
  TIAN_API: {
    ...
    key: 'cab985621a603b21722112c619431429',
  ...
  USERS: [
    {
      ...
      // id: 'ofxzP6LAKqwxDAsImmpFMJBflXDM',
      id: 'ofxzP6OZemxxgdem0pUAiRw8dwLs',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
  ...
  SLOT_LIST: [
    ...
    // 这样配置的话，就会每次随机选一句话发送
    {
      ...
      contents: [
        '我们只是没有聊天，又不是不爱了,\r我知道你在，你也知道我在，\r加油！'
      ],
    }
    // 你可以不断按格式往下增加
    // ...
